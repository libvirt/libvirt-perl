...
domain_event_register_any(conref, domref, eventID, cb)
 ...
 CODE:
    ...
    case VIR_DOMAIN_EVENT_ID_VCPU_REMOVED:
        callback = VIR_DOMAIN_EVENT_CALLBACK(_domain_event_vcpu_removed_callback);
        break;
    case VIR_DOMAIN_EVENT_ID_CHANNEL_LIFECYCLE:
        callback = VIR_DOMAIN_EVENT_CALLBACK(_domain_event_channel_lifecycle_callback);
        break;
    default:
        callback = VIR_DOMAIN_EVENT_CALLBACK(_domain_event_generic_callback);
        break;
...
BOOT:
{
    ...
    REGISTER_CONSTANT(VIR_CONNECT_GET_DOMAIN_CAPABILITIES_SUPPORTED_CPU_FEATURES, DOMAIN_CAPABILITIES_SUPPORTED_CPU_FEATURES);
    ...
    REGISTER_CONSTANT(VIR_DOMAIN_SETVCPU_AFFECT_CURRENT, SETVCPU_AFFECT_CURRENT);
    ...
    REGISTER_CONSTANT(VIR_DOMAIN_EVENT_ID_CHANNEL_LIFECYCLE, EVENT_ID_CHANNEL_LIFECYCLE);
    ...
    REGISTER_CONSTANT(VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_CONNECTED, EVENT_CHANNEL_LIFECYCLE_STATE_CONNECTED);
    REGISTER_CONSTANT(VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_DISCONNECTED, EVENT_CHANNEL_LIFECYCLE_STATE_DISCONNECTED);

    REGISTER_CONSTANT(VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_UNKNOWN, EVENT_CHANNEL_LIFECYCLE_REASON_UNKNOWN);
    REGISTER_CONSTANT(VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_DOMAIN_STARTED, EVENT_CHANNEL_LIFECYCLE_REASON_DOMAIN_STARTED);
    REGISTER_CONSTANT(VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_CHANNEL, EVENT_CHANNEL_LIFECYCLE_REASON_CHANNEL);
    ...
    REGISTER_CONSTANT(VIR_DOMAIN_BLOCK_RESIZE_EXTEND, BLOCK_RESIZE_EXTEND);
    ...
    REGISTER_CONSTANT(VIR_DOMAIN_LIFECYCLE_ACTION_PRESERVE_RUNNING, LIFECYCLE_ACTION_PRESERVE_RUNNING);
    ...
    REGISTER_CONSTANT(VIR_DOMAIN_GUEST_INFO_DEVICES, GUEST_INFO_DEVICES);
    ...
    REGISTER_CONSTANT_STR(VIR_DOMAIN_GUEST_INFO_DEVICE_COUNT, GUEST_INFO_DEVICE_COUNT);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_GUEST_INFO_DEVICE_PREFIX, GUEST_INFO_DEVICE_PREFIX);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_GUEST_INFO_DEVICE_SUFFIX_DRIVER_DATE, GUEST_INFO_DEVICE_SUFFIX_DRIVER_DATE);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_GUEST_INFO_DEVICE_SUFFIX_DRIVER_NAME, GUEST_INFO_DEVICE_SUFFIX_DRIVER_NAME);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_GUEST_INFO_DEVICE_SUFFIX_DRIVER_VERSION, GUEST_INFO_DEVICE_SUFFIX_DRIVER_VERSION);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_GUEST_INFO_DEVICE_SUFFIX_ID_TYPE, GUEST_INFO_DEVICE_SUFFIX_ID_TYPE);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_GUEST_INFO_DEVICE_SUFFIX_PCI_DEVICE, GUEST_INFO_DEVICE_SUFFIX_PCI_DEVICE);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_GUEST_INFO_DEVICE_SUFFIX_PCI_VENDOR, GUEST_INFO_DEVICE_SUFFIX_PCI_VENDOR);
    ...
    REGISTER_CONSTANT_STR(VIR_DOMAIN_STATS_CPU_ENERGY_MONITOR_COUNT, STATS_CPU_ENERGY_MONITOR_COUNT);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_STATS_CPU_ENERGY_MONITOR_PREFIX, STATS_CPU_ENERGY_MONITOR_PREFIX);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_STATS_CPU_ENERGY_MONITOR_SUFFIX_NAME, STATS_CPU_ENERGY_MONITOR_SUFFIX_NAME);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_STATS_CPU_ENERGY_MONITOR_SUFFIX_VCPUS, STATS_CPU_ENERGY_MONITOR_SUFFIX_VCPUS);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_STATS_CPU_ENERGY_MONITOR_SUFFIX_PKG_COUNT, STATS_CPU_ENERGY_MONITOR_SUFFIX_PKG_COUNT);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_STATS_CPU_ENERGY_MONITOR_SUFFIX_PKG_PREFIX, STATS_CPU_ENERGY_MONITOR_SUFFIX_PKG_PREFIX);
    REGISTER_CONSTANT_STR(VIR_DOMAIN_STATS_CPU_ENERGY_MONITOR_SUFFIX_PKG_SUFFIX_ID, STATS_CPU_ENERGY_MONITOR_SUFFIX_PKG_SUFFIX_ID);
    ...
    REGISTER_CONSTANT_STR(VIR_DOMAIN_STATS_IOTHREAD_SUFFIX_POLL_WEIGHT, STATS_IOTHREAD_SUFFIX_POLL_WEIGHT);
